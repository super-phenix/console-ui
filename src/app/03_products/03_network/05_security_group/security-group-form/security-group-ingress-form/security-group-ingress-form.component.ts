...
import { IngressRule } from '@products/00_shared/models/network/security-group/create-security-group.model';
import { NetworkRuleFormComponent } from '../network-rule-form/network-rule-form.component';

@Component({
  selector: 'spx-security-group-ingress-form',
  imports: [NetworkRuleFormComponent, MatButtonModule, MatIconModule],
  templateUrl: './security-group-ingress-form.component.html',
})
export class SecurityGroupIngressFormComponent implements OnInit {
