...
import { EgressRule } from '@products/00_shared/models/network/security-group/create-security-group.model';
import { NetworkRuleFormComponent } from '../network-rule-form/network-rule-form.component';

@Component({
  selector: 'spx-security-group-egress-form',
  imports: [NetworkRuleFormComponent, MatButtonModule, MatIconModule],
  templateUrl: './security-group-egress-form.component.html',
})
export class SecurityGroupEgressFormComponent implements OnInit {
